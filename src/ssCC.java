 ...
 *  	Your tokenizer must implement the iTokenizer interface that is generated by implementing a nextToken()
			...
			if (args[i].startsWith("-")) { 
				...
				if (args[i].equals("--tokenizer-only")) {
					...
					if (!packagename.matches("[a-zA-Z]\\w*")) { // must start with an alpha char, followed by any number of alphanumeric
						throw new ArgumentParsingException("Invalid package name \"" + packagename + "\"");
					}
